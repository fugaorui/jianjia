...
- (void)notifyApplication:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
    ...
    if (result) {
        ...
        self.notificationLaunchBlock = ^{
            [AppCanRootWebViewEngine() callbackWithFunctionKeyPath:kReceiveNotificationOpenCallbackKeyPath arguments:ACArgsPack(@"no",@"no",result.ac_JSONFragment) completion:nil];
        };
    }
...
- (void)notifyApplication:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification{
    ...
    [AppCanRootWebViewEngine() callbackWithFunctionKeyPath:keyPath arguments:ACArgsPack(@"no",@"no",result.ac_JSONFragment) completion:nil];
...
- (void)jpushNotificationCenter:(UNUserNotificationCenter *)center willPresentNotification:(UNNotification *)notification withCompletionHandler:(void (^)(NSInteger))completionHandler {
    ...
    [AppCanRootWebViewEngine() callbackWithFunctionKeyPath:kReceiveNotificationCallbackKeyPath arguments:ACArgsPack(@"no",@"no",result.ac_JSONFragment) completion:nil];
    UNNotificationPresentationOptions option = self.showNotificationAlertInForeground ? UNNotificationPresentationOptionBadge|UNNotificationPresentationOptionSound: 0 ;
